      ...
      <main className="flex-grow flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl w-full">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">Add PDF Watermark</h1>
            <p className="text-gray-600">Apply a watermark to your PDF documents for copyright protection or status indication.</p>
          </div>
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 space-y-8">
                ...
                <div className="flex justify-center pt-4">
                  <button
                    ...
                    `}
                  >
                    {isProcessing ? <Loader2 className="w-7 h-7 animate-spin" /> : <Type className="w-7 h-7" />}
          ...
          {isDone && (
            <div className="bg-green-50 border border-green-100 p-8 rounded-2xl flex items-center gap-5 animate-in fade-in slide-in-from-bottom-4 shadow-sm">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 font-bold">The watermark has been added to every page of your document.</p>
              </div>
            </div>
          )}
        </div>
