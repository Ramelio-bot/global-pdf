      ...
      <main className="flex-grow flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl w-full">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">Rotate PDF Pages</h1>
            <p className="text-gray-600">Permanently rotate all pages in your PDF document.</p>
          </div>
          ...
          <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 mb-8 animate-in fade-in slide-in-from-bottom-4">
            ...
            {file && (
              <div className="animate-in fade-in slide-in-from-bottom-4">
                <label className="block text-sm font-bold text-gray-700 mb-6 text-center uppercase tracking-widest">
                ...
                <div className="grid grid-cols-3 gap-6 mb-12">
                  {[90, 180, 270].map((deg) => (
                    <button
                      ...
                      className={`py-6 rounded-2xl font-black text-xl transition-all border-2
                        ${rotation === deg ? "bg-red-600 text-white border-red-600 shadow-xl scale-105" : "bg-white text-gray-600 border-gray-100 hover:border-red-200 hover:shadow-md"}
                      `}
                    >
                      {deg}°
                    </button>
                ...
                <div className="flex justify-center">
                  ...
                  >
                    {isProcessing ? <Loader2 className="w-7 h-7 animate-spin" /> : <RotateCw className="w-7 h-7" />}
                    Rotate & Download PDF
                  </button>
                </div>
              </div>
          ...
          {isDone && (
            <div className="bg-green-50 border border-green-100 p-8 rounded-2xl flex items-center gap-5 animate-in fade-in slide-in-from-bottom-4 shadow-sm">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 font-bold">The rotated PDF has been downloaded automatically.</p>
              </div>
            </div>
          )}
        </div>
