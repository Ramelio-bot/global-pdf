  ...
  const convertPdfToWord = async () => {
    ...
    try {
      ...
      for (let i = 1; i <= pdf.numPages; i++) {
        ...
        // Extract text and join into a single string per page
        ...
        // Add an empty paragraph as a simple page separator
      ...
      alert("An error occurred while converting PDF to Word. Please ensure the file is not corrupted.");
    } finally {
      ...
      <main className="flex-grow flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl w-full">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">Convert PDF to Word</h1>
            <p className="text-gray-600">Extract text from your PDF and save it as an editable Word document (.docx).</p>
          </div>
            ...
            >
              {file ? (
                ...
                <div className="flex flex-col items-center justify-center pt-5 pb-6 group-hover:scale-105 transition-all duration-300">
                  <div className="bg-gray-100 p-4 rounded-full mb-4 group-hover:bg-blue-50 transition-colors shadow-inner">
                    <FileUp className="w-10 h-10 text-gray-400 group-hover:text-blue-500 transition-colors" />
                  </div>
          ...
          {isDone && (
            <div className="mb-8 bg-green-50 border border-green-100 p-6 rounded-2xl flex items-center gap-4 animate-in fade-in slide-in-from-bottom-4">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 font-bold">Your Word document has been downloaded automatically.</p>
              </div>
            </div>
          )}
